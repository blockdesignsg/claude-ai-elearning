    ...
    <div className="bg-white min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-8 space-y-6">
          ...
          <button className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-slate-300 text-foreground font-medium hover:bg-slate-50 transition-colors">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-slate-600">または</span>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <Link
            href="/"
            className="text-slate-600 hover:text-foreground font-medium"
          >
            ← ホームページに戻る
          </Link>
        </div>
